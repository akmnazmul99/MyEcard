...
public class Facebook extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        onClickShareFacebookButtonListener();
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_profile) {
            Intent nav_profile_intent = new Intent(Facebook.this, UserProfile.class);
            startActivity(nav_profile_intent);
        } else if (id == R.id.nav_all_cards) {
            Intent nav_all_cards_intent = new Intent(Facebook.this, AllCards.class);
            startActivity(nav_all_cards_intent);
        } else if (id == R.id.nav_settings) {
            Intent nav_setting_intent = new Intent(Facebook.this, Settings.class);
            startActivity(nav_setting_intent);
        } else if (id == R.id.nav_logout) {
            Intent nav_logout_intent = new Intent(Facebook.this, Login.class);
