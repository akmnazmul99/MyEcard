...
public class SingleCardLayout6 extends AppCompatActivity
    ...
    public void onClick(DialogInterface dialog, int pos) {
        ...
        {
            case 0:
                Intent email_intent = new Intent(SingleCardLayout6.this, EmailCompose.class);
                startActivityForResult(email_intent, 0);
                break;
            case 1:
                Intent linkedin_intent = new Intent(SingleCardLayout6.this, Linkedin.class);
                startActivityForResult(linkedin_intent, 0);
                break;
            case 2:
                Intent print_intent = new Intent(SingleCardLayout6.this, PrintCard.class);
