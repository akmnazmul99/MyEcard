...
public class SingleCardLayout2 extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_single_card_layout2);
        ...
        NavigationView navigationView = (NavigationView) findViewById(R.id.single_card_layout2_nav_view);
        ...
        ad = builder.create();
        imageUploadDialog = new Dialog(SingleCardLayout2.this);
        this.initTemplate();
                    ...
                    if(stringProfile != null)
                    {
                        ...
                        if(profile.isSuccess())
                        {
                            ...
                            try
                            {
                                ...
                                tvLC2FullName.setText(profile.getUser().getFirstName()+" "+profile.getUser().getLastName());
                                tvLC2JobTitle.setText(profile.getDesignation());
                                tvLC2Cell.setText(profile.getUser().getCell());
    ...
    public void onClickShareCardButtonListener()
    {
        ...
        button_open_dialog.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                LinearLayout idCardDesign = (LinearLayout)findViewById(R.id.idCardDesign2);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.single_card_layout2, menu);
        return true;
    }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_profile) {
            Intent nav_profile_intent = new Intent(SingleCardLayout2.this, UserProfile.class);
            startActivity(nav_profile_intent);
        } else if (id == R.id.nav_all_cards) {
            Intent nav_all_cards_intent = new Intent(SingleCardLayout2.this, AllCards.class);
            startActivity(nav_all_cards_intent);
        } else if (id == R.id.nav_settings) {
            Intent nav_setting_intent = new Intent(SingleCardLayout2.this, Settings.class);
    ...
    public void onClick(DialogInterface dialog, int pos) {
        ...
        switch( pos )
        {
            case 0:
                ...
                {
                    Intent facebookIntent = new Intent(SingleCardLayout2.this, Facebook.class);
            ...
            case 1:
                ...
                {
                    Intent linkedinIntent = new Intent(SingleCardLayout2.this, Linkedin.class);
            ...
            case 2:
                ...
                Intent emailIntent = new Intent(SingleCardLayout2.this, EmailCompose.class);
