...
public class SingleCardLayout3 extends AppCompatActivity
    ...
    private TextView tvLC3FullName, tvLC3JobTitle, tvLC3Cell, tvLC3Email, tvLC3Website, tvLC3Address;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_single_card_layout3);
        ...
        NavigationView navigationView = (NavigationView) findViewById(R.id.single_card_layout3_nav_view);
        ...
        ad = builder.create();
        imageUploadDialog = new Dialog(SingleCardLayout3.this);
        this.initTemplate();
                    ...
                    if(stringProfile != null)
                    {
                        ...
                        if(profile.isSuccess())
                        {
                            ...
                            try
                            {
                                ...
                                tvLC3FullName.setText(profile.getUser().getFirstName()+" "+profile.getUser().getLastName());
                                tvLC3JobTitle.setText(profile.getDesignation());
                                tvLC3Cell.setText(profile.getUser().getCell());
                                tvLC3Email.setText(profile.getUser().getEmail());
    ...
    public void onClickShareCardButtonListener()
    {
        ...
        button_open_dialog.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                LinearLayout idCardDesign = (LinearLayout)findViewById(R.id.idCardDesign3);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.single_card_layout3, menu);
        return true;
    }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_profile) {
            Intent nav_profile_intent = new Intent(SingleCardLayout3.this, UserProfile.class);
            startActivity(nav_profile_intent);
        } else if (id == R.id.nav_all_cards) {
            Intent nav_all_cards_intent = new Intent(SingleCardLayout3.this, AllCards.class);
            startActivity(nav_all_cards_intent);
        } else if (id == R.id.nav_settings) {
            Intent nav_setting_intent = new Intent(SingleCardLayout3.this, Settings.class);
    ...
    public void onClick(DialogInterface dialog, int pos) {
        ...
        switch( pos )
        {
            case 0:
                ...
                {
                    Intent facebookIntent = new Intent(SingleCardLayout3.this, Facebook.class);
            ...
            case 1:
                ...
                {
                    Intent linkedinIntent = new Intent(SingleCardLayout3.this, Linkedin.class);
            ...
            case 2:
                ...
                Intent emailIntent = new Intent(SingleCardLayout3.this, EmailCompose.class);
