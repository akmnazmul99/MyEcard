...
public class SingleCardLayout4 extends AppCompatActivity
    ...
    private TextView tvLC4FullName, tvLC4JobTitle, tvLC4Cell, tvLC4Email, tvLC4Website, tvLC4Address;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_single_card_layout4);
        ...
        NavigationView navigationView = (NavigationView) findViewById(R.id.single_card_layout4_nav_view);
        ...
        ad = builder.create();
        imageUploadDialog = new Dialog(SingleCardLayout4.this);
        this.initTemplate();
                    ...
                    if(stringProfile != null)
                    {
                        ...
                        if(profile.isSuccess())
                        {
                            ...
                            try
                            {
                                ...
                                tvLC4FullName.setText(profile.getUser().getFirstName()+" "+profile.getUser().getLastName());
                                tvLC4JobTitle.setText(profile.getDesignation());
                                tvLC4Cell.setText(profile.getUser().getCell());
                                tvLC4Email.setText(profile.getUser().getEmail());
                                tvLC4Website.setText(profile.getCompany().getWebsite());
                                tvLC4Address.setText(profile.getCompany().getAddress());
    ...
    public void onClickShareCardButtonListener()
    {
        ...
        button_open_dialog.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                LinearLayout idCardDesign = (LinearLayout)findViewById(R.id.idCardDesign4);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.single_card_layout4, menu);
        return true;
    }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_profile) {
            Intent nav_profile_intent = new Intent(SingleCardLayout4.this, UserProfile.class);
            startActivity(nav_profile_intent);
        } else if (id == R.id.nav_all_cards) {
            Intent nav_all_cards_intent = new Intent(SingleCardLayout4.this, AllCards.class);
            startActivity(nav_all_cards_intent);
        } else if (id == R.id.nav_settings) {
            Intent nav_setting_intent = new Intent(SingleCardLayout4.this, Settings.class);
    ...
    public void onClick(DialogInterface dialog, int pos) {
        ...
        switch( pos )
        {
            case 0:
                ...
                {
                    Intent facebookIntent = new Intent(SingleCardLayout4.this, Facebook.class);
            ...
            case 1:
                ...
                {
                    Intent linkedinIntent = new Intent(SingleCardLayout4.this, Linkedin.class);
            ...
            case 2:
                ...
                Intent emailIntent = new Intent(SingleCardLayout4.this, EmailCompose.class);
