...
public class SingleCardLayout7 extends AppCompatActivity
    ...
    private TextView tvLC7FullName, tvLC7JobTitle, tvLC7Cell, tvLC7Email, tvLC7Website, tvLC7Address;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_single_card_layout7);
        ...
        NavigationView navigationView = (NavigationView) findViewById(R.id.single_card_layout7_nav_view);
        ...
        ad = builder.create();
        imageUploadDialog = new Dialog(SingleCardLayout7.this);
        this.initTemplate();
                    ...
                    if(stringProfile != null)
                    {
                        ...
                        if(profile.isSuccess())
                        {
                            ...
                            try
                            {
                                ...
                                tvLC7FullName.setText(profile.getUser().getFirstName()+" "+profile.getUser().getLastName());
                                tvLC7JobTitle.setText(profile.getDesignation());
                                tvLC7Cell.setText(profile.getUser().getCell());
                                tvLC7Email.setText(profile.getUser().getEmail());
                                tvLC7Website.setText(profile.getCompany().getWebsite());
                                tvLC7Address.setText(profile.getCompany().getAddress());
    ...
    public void onClickShareCardButtonListener()
    {
        ...
        button_open_dialog.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                LinearLayout idCardDesign = (LinearLayout)findViewById(R.id.idCardDesign7);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.single_card_layout7, menu);
        return true;
    }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_profile) {
            Intent nav_profile_intent = new Intent(SingleCardLayout7.this, UserProfile.class);
            startActivity(nav_profile_intent);
        } else if (id == R.id.nav_all_cards) {
            Intent nav_all_cards_intent = new Intent(SingleCardLayout7.this, AllCards.class);
            startActivity(nav_all_cards_intent);
        } else if (id == R.id.nav_settings) {
            Intent nav_setting_intent = new Intent(SingleCardLayout7.this, Settings.class);
    ...
    public void onClick(DialogInterface dialog, int pos) {
        ...
        switch( pos )
        {
            case 0:
                ...
                {
                    Intent facebookIntent = new Intent(SingleCardLayout7.this, Facebook.class);
            ...
            case 1:
                ...
                {
                    Intent linkedinIntent = new Intent(SingleCardLayout7.this, Linkedin.class);
            ...
            case 2:
                ...
                Intent emailIntent = new Intent(SingleCardLayout7.this, EmailCompose.class);
